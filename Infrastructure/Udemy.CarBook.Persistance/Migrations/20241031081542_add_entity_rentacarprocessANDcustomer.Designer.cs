...
namespace Udemy.CarBook.Persistance.Migrations
{
    ...
    [Migration("20241031081542_add_entity_rentacarprocessANDcustomer")]
    partial class add_entity_rentacarprocessANDcustomer
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("UdemyCarBook.Domain.Entities.RentACarProcess", b =>
                {
                    ...
                    b.Property<TimeSpan>("DropOffTimeDate")
                        .HasColumnType("time");
                    ...
                    b.Property<TimeSpan>("PickUpTimeDate")
                        .HasColumnType("time");
